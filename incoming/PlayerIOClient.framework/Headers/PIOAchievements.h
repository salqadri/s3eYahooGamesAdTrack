 ...
 */
- (void)loadWithuserIds:(NSArray*)userIds successBlock:(void(^)(NSDictionary*))successBlock;
...
/**
 ...
 @param errorBlock Callback block that will be called instead of successBlock if an error occurs.
 */
- (void)loadWithuserIds:(NSArray*)userIds successBlock:(void(^)(NSDictionary*))successBlock errorBlock:(void(^)(PIOError*))errorBlock;
