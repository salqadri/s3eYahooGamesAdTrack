 ...
 */
- (void)setSegmentsWithSegments:(NSMutableArray*)segments successBlock:(void(^)())successBlock errorBlock:(void(^)(PIOError *error))errorBlock;
 ...
 * @param errorBlock Callback block that will be called instead of successBlock if an error occurs during the operation.
 */
- (void)refreshWithSuccessBlock:(void(^)())successBlock errorBlock:(void(^)(PIOError *error))errorBlock;

/**
 * Every API call performs a session keep-alive implicitly, but if there will be long periods of inactivity
 * this method can be used to ensure that the session that was started through Authenticate does not die out.
 * @param callback Callback that will be called when the operation was completed
 */
 ...
 * Every API call performs a session keep-alive implicitly, but if there will be long periods of inactivity
 * this method can be used to ensure that the session that was started through Authenticate does not die out.
 * @param successBlock Callback block that will be called when the operation was completed
 */
- (void)sessionKeepAliveWithSuccessBlock:(void(^)())successBlock;

/**
 * Every API call performs a session keep-alive implicitly, but if there will be long periods of inactivity
 * this method can be used to ensure that the session that was started through Authenticate does not die out.
 * @param successBlock Callback that will be called when the operation was completed
 * @param errorBlock Callback block that will be called when the operation was completed
 */
- (void)sessionKeepAliveWithSuccessBlock:(void(^)())successBlock errorBlock:(void(^)(PIOError *error))errorBlock;
 ...
 * @param errorBlock Callback block that will be called instead of successBlock if an error occurs during the operation.
 */
- (void)trackInvitedByWithInvitingUserId:(NSString*)invitingUserid invitationChannel:(NSString*)invitationChannel successBlock:(void(^)())successBlock errorBlock:(void(^)(PIOError *error))errorBlock;
 ...
 * @param errorBlock Callback block that will be called instead of successBlock if an error occurs during the operation.
 */
- (void)trackEventWithEventType:(NSString*)eventType value:(int)value successBlock:(void(^)())successBlock errorBlock:(void(^)(PIOError *error))errorBlock;
 ...
 * @param errorBlock Callback block that will be called instead of successBlock if an error occurs during the operation.
 */
- (void)trackExternalPaymentWithCurrency:(NSString*)currency amount:(int)amount successBlock:(void(^)())successBlock errorBlock:(void(^)(PIOError *error))errorBlock;
