 ...
 */
- (void)sendWithRequestType:(NSString*)requestType requestData:(NSDictionary*)requestData recipients:(NSArray*)recipients successBlock:(void(^)())successBlock;
 ...
 */
- (void)sendWithRequestType:(NSString*)requestType requestData:(NSDictionary*)requestData recipients:(NSArray*)recipients successBlock:(void(^)())successBlock errorBlock:(void(^)(PIOError*))errorBlock;
 ...
 * Delete the given requests asynchronously. Will also update the Received property after deletion is complete.
 ...
 @param successBlock Callback block that will be called when the operation succeeds.
 */
- (void)deleteWithGameRequests:(NSArray*)requests successBlock:(void(^)())successBlock;
 ...
 */
- (void)deleteWithGameRequests:(NSArray*)requests successBlock:(void(^)())successBlock errorBlock:(void(^)(PIOError *))errorBlock;
