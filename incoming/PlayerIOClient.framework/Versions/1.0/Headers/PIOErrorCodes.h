// This file was auto-generated by PlayerIO.WebService.ObjCClientGenerator+ObjectiveCErrorCodesInterface.  DO NOT EDIT!
...
+(PIOErrorCode) NetworkIssue;
/** Cannot access OneScore before Refresh() has been called. */
+(PIOErrorCode) OneScoreNotLoaded;
...
+(PIOErrorCode) DialogClosed;
/** Check cookie required. */
+(PIOErrorCode) AdTrackCheckCookie;
@end
