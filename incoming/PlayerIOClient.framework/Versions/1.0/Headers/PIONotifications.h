...
/**
 ...
 @param endpointType The endpoint type to register. For example: "ios-push-notifications"
 ...
 */
- (void)registerEndpointWithEndpointType:(NSString*)endpointType identifier:(NSString*)identifier configuration:(NSDictionary*)configuration enabled:(BOOL)enabled successBlock:(void(^)())successBlock;
 ...
 */
- (void)registerEndpointWithEndpointType:(NSString*)endpointType identifier:(NSString*)identifier configuration:(NSDictionary*)configuration enabled:(BOOL)enabled successBlock:(void(^)())successBlock errorBlock:(void(^)(PIOError*))errorBlock;
...
/**
 Send one or more notifications
 @param notifications Array of PIONotification objects to send
 @param successBlock Callback block that is invoked when operation succeeds
 */
- (void)sendNotifications:(NSArray*)notifications successBlock:(void(^)())successBlock;
 ...
 */
- (void)sendNotifications:(NSArray*)notifications successBlock:(void(^)())successBlock errorBlock:(void(^)(PIOError*))errorBlock;
...
/**
 ...
 @param successBlock Callback block that is invoked when operation succeeds
 */
- (void)toggleEndpoints:(NSArray*)endpoints enabled:(BOOL)enabled successBlock:(void(^)())successBlock;
...
/**
 ...
 @param errorBlock Callback block that is invoked when operation fails
 */
- (void)toggleEndpoints:(NSArray*)endpoints enabled:(BOOL)enabled successBlock:(void(^)())successBlock errorBlock:(void(^)(PIOError*))errorBlock;
...
/**
 ...
 @param successBlock Callback block that is invoked when operation succeeds.
 */
- (void)deleteEndpoints:(NSArray*)endpoints successBlock:(void(^)())successBlock;
 ...
 * @param errorBlock Callback block that is invoked when operation fails.
 */
- (void)deleteEndpoints:(NSArray*)endpoints successBlock:(void(^)())successBlock errorBlock:(void(^)(PIOError*))errorBlock;
