 ...
 */
- (void)loadProfilesWithUserIds:(NSArray*)userIds successBlock:(void(^)(NSArray*))successBlock;
 ...
 */
- (void)loadProfilesWithUserIds:(NSArray*)userIds successBlock:(void(^)(NSArray*))successBlock errorBlock:(void(^)(PIOError*))errorBlock;
