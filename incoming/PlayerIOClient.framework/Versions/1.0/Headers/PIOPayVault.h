 ...
 * @param provider The name of the PayVault provider to use for the purchase.
 * @param providerArguments The information needed to finalize this purchase.
 * @param successBlock The callback that will be used to return results. On success its successBlock method will be called, otherwise its onError method.
 */
- (void) useBuyInfoWithProvider:(NSString*)provider providerArguments:(NSDictionary*)providerArguments successBlock:(void (^)(NSDictionary*))successBlock;
 ...
 * @param providerArguments The information needed to finalize this purchase.
 * @param successBlock The callback that will be used to return results. On success its successBlock method will be called, otherwise its onError method.
 * @param errorBlock The callback that will be called on error with information about the error.
 */
- (void) useBuyInfoWithProvider:(NSString*)provider providerArguments:(NSDictionary*)providerArguments successBlock:(void (^)(NSDictionary*))successBlock errorBlock:(void (^)(PIOError* error))errorBlock;
